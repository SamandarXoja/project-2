    ...
    <>
      <section className="relative mt-1 text-primary xs:pl-[0px] px-[15px] xs:pr-[0px] sm:pl-[22px] sm:pr-[22px] md:pl-[22px] md:pr-[22px] lg:pl-[22px] lg:pr-[22px] xl:pl-[22px] xl:pr-[22px] 2xl:pl-[22px] 2xl:pr-[22px]">
        <div className="relative h-full max-w-[1504px] mx-auto ">
          <div className="pointer-events-none absolute bottom-0 left-0 right-0 top-0 rounded-[30px] bg-[linear-gradient(236deg,_rgba(26,53,96,0)_-39.54%,_#1A3560_102.94%)]" />
          <video
            className="h-[758px] w-full rounded-[30px] object-cover"
            muted
            loop
            autoPlay
            playsInline
          ...
          <div className="absolute left-0 top-0 flex h-full flex-col justify-end xs:ml-[20px] xs:max-w-[426px] xs:pb-[20px] sm:ml-[20px] sm:max-w-[526px] sm:pb-[20px] md:ml-[78px] md:max-w-[526px] md:pb-[72px] lg:ml-[78px] lg:max-w-[526px] lg:pb-[72px] xl:ml-[72px] xl:max-w-[626px] xl:pb-[72px] 2xl:ml-[78px] 2xl:max-w-[626px] 2xl:pb-[72px]">
